<div>
    <div class="flex gap-4">
        <a href="{{route('staff-user-accounts')}}">
        ...
        <x-Essentials.page-title>Patient Accounts</x-Essentials.page-title>
    </div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg">
                    ...
                    <td class="px-6 py-6 flex gap-2 items-center">
                        <svg wire:click='view({{$patient->id}})' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-400">
                ...
                <div class="w-full">
                    <div class='flex gap-4 w-full'>
                        <div class='flex flex-col gap-1 mb-4 text-fontColor w-full text-based font-semibold'>
                            <h1>Patient ID : <span class="text-gray-400">{{$patient_id}}</span></h1>
                            <h1 class="">Name : <span class="text-gray-400" wire:model='service_name'>{{$full_name}}</span></h1>
                            <h1 class="">Email : <span class="text-gray-400" wire:model='service_category_id'>{{$email}}</span></h1>
                            <h1 class="">Username : <span class="text-gray-400"     wire:model='price'>{{$username}}</span></h1>
                            <h1>Status : 
