    ...
    <div class=" bg-white border border-solid rounded-lg px-4 py-4 border-t-4 border-t-primary-green border-t-solid shadow-md w-[70%] max-h-[530px] overflow-y-auto">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
            <li class="me-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-tab" data-tabs-target="#medical-records" type="button" role="tab" aria-controls="medical-records" aria-selected="false">Medical Records</button>
            </li>
            <li class="me-2" role="presentation">
                ...
                <div>
                    ...
                    <div class="mb-4 flex gap-2 items-center justify-between w-full">
                        ...
                        <div class="flex gap-2 items-center">
                            <a href="{{route('medical-record', ['patient_id' => $patient_id])}}">
