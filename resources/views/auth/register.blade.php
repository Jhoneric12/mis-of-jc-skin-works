    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" class="py-4">
            <div class="w-full mb-8">
                <h1 class="text-center font-extrabold text-2xl">Sign Up</h1>
                <p class="text-sm text-center text-gray-600 mt-1">Provide information that is true and correct</p>
            </div>
            @csrf
            ...
            <div class="flex md:flex-row flex-col gap-2 mt-2">
                <div class="w-full">
            ...
            <div class="w-full mt-2 flex items-center flex-col md:flex-row gap-2">
                <div class="w-full">
                    <x-label for="civilstaus" value="{{ __('Civil Status') }}" />
                    <select name="civilstatus" id="civilstatus" class="w-full mt-1 text-base border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm mt-1'">
                        <option value="">- Select Options - </option>
                ...
                <div class="w-full">
                    ...
                    <select name="gender" id="gender" class="w-full mt-1 text-base border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm mt-1'">
                        <option value="">- Select Options -</option>
            ...
            <div class="w-full mt-2 flex-col md:flex-row gap-2">
                <div class="w-full">
                ...
                <div class="mt-4">
                    <x-label for="terms">
                        <div class="flex items-center">
                            ...
                            <div class="ms-2 text-xs md:text-sm">
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-xs text-gray-600  md:text-sm hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
