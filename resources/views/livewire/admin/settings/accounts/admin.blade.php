<div>
    <div class="flex gap-4">
        ...
        <x-Essentials.page-title>Admin Accounts</x-Essentials.page-title>
    </div>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg">
                    ...
                    <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                            <div class="flex-shrink-0 h-10 w-10"> <img class="h-10 w-10 rounded-full" src="{{ $admin->profile_photo_url }}" alt="{{ $admin->name }}"> </div>
                            <div class="ml-4">
                                <div class="text-xs font-medium text-gray-900"> {{ $admin->first_name .  " " . $admin->last_name }} </div>
                                <div class="text-xs text-gray-500"> {{ $admin->email }} </div>
                            </div>
                        @else
                            <div class="ml-4">
                                <div class="text-xs font-medium text-gray-900"> {{ $admin->name }} </div>
                                <div class="text-xs text-gray-500"> {{ $admin->email }} </div>
                            </div>
                        @endif
                    </th>
                    ...
                    <td class="px-6 py-6 flex gap-2 items-center">
                        <svg wire:click='view({{$admin->id}})' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-400">
                        ...
                        <svg wire:click='editStatus({{$admin->id}})' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-400">
