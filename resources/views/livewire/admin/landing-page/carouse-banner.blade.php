@if (count($banners) > 0)
<div id="default-carousel" class="relative w-full bg-[#EBF7DD] md:h-[20rem] h-[10rem] z-10 " data-carousel="slide">
    <!-- Carousel wrapper -->
...
@else
<div class="relative w-full bg-[#EBF7DD] md:h-[25rem] z-10 hidden md:hidden lg:hidden xl:hidden" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative flex justify-center gap-4 items-center overflow-hidden h-full">
        @foreach ($banners as $index => $banner)
            <!-- Item -->
