            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                    ...
                    <div class="col-span-12">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg">
                                                                ...
                                                                <td class="px-6 py-6 flex gap-2 ">
                                                                    <a href="{{route('staff-view-appointments', ['appointment_id' => $appointment->id])}}" class="hover:cursor-pointer text-[#5FC26C]">
                                                                        View Details
                                                                    </a>                     
                                                                </td>
                                                            </tr>
                        ...
                        <div class="bg-white p-4 shadow-lg rounded-lg mt-6">
