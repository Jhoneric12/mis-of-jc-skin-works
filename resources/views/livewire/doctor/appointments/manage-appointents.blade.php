<div>
    <div class="flex gap-4">
        <a href="{{route('doctor-appointment-calendar')}}">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg">
                    ...
                    <td class=" px-6 py-6 flex gap-2">              
                        <a href="{{route('doctor-view-appointment', ['appointment_id' => $appointment->id])}}">
                        ...
                        <div @if($appointment->status == 'Completed' || $appointment->status == 'Cancelled' || $appointment->status == 'Confirmed') style="display:none" @endif>
                            <a href="{{route('staff-billing', ['appointment_id' => $appointment->id])}}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"  class="w-6 h-6 text-gray-400">
                        ...
                        {{-- <svg wire:click='editStatus({{$appointment->id}})' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-400">
