    ...
    <div>
        ...
        <div class="relative overflow-x-auto sm:rounded-lg shadow-md px-6 py-8 border-2 border-solid mt-6 ">
            ...
            <div class="flex justify-between mt-6">
                ...
                <div class="flex flex-col gap-4 px-10 py-3 border border-solid border-[#5FC26C] bg-[#F0F5EB] text-[#5FC26C]">
                    <div>{{ number_format(array_sum(array_map(function($item) { return (float) $item['total']; }, $cart)), 2) }}</div>
                </div>
            </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class='flex flex-col gap-1 mb-4 text-fontColor w-full'>
                                    ...
                                    <input wire:model="patient_name" type="text" class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
