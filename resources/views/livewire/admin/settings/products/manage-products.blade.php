<div>
    <div class="flex gap-4">
        ...
        <x-Essentials.page-title>Manage Products </x-Essentials.page-title>
    </div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg">
                    <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img src="{{ asset('storage/' . $product->product_image_path) }}" alt="{{ $product->product_name }}" class="rounded-full h-10 w-10 object-cover">  
                        <div class="ps-3">
                            <div class="text-xs font-semibold">{{$product->product_name}}</div>
                ...
                <div>
                    <div class='flex flex-col w-full'>
                        ...
                        <div class='flex flex-col gap-1 mb-4 w-full'>
                            ...
                            <select wire:model='product_category_id' class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="flex gap-4">
                            <div class='flex flex-col gap-1 mb-4 text-fontColor w-full'>
                                ...
                                <input wire:model="min_qty" type="number"  class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
